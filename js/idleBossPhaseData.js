...
const IDLE_BOSS_PHASE = {
  ...
  /**
   * 戴米安（8880100→8880101）；**共血一條**：血條固定前 70%＝一階、後 30%＝二階（與兩階實際血量無關）。
   * 出傷＝PA × attackHpRatio × dmgMult。印章不做；P2 小劍＝flyingSword2。
   * formHpMult＝各階實際可打血量；轉階＝一階池打完。藍球／世界樹門檻走血條比例。
   */
  '15': {
    name: '戴米安',
    kind: 'damien',
    bodyForms: [
      { statMob: '8880100', visualMob: '8880100' },
      { statMob: '8880101', visualMob: '8880101' },
    ],
    chestMob: '8950111',
    /** 二階最終死亡動畫（8880121 die1） */
    dieMob: '8880121',
    /** 獎勵箱 die1 第幾幀噴掉落 */
    chestRewardFrame: 17,
    exitSec: 30,
    damienKit: {
      // 血條固定：前 barP1Share＝一階、後 barP2Share＝二階（與兩階實際血量無關）
      barP1Share: 0.7,
      barP2Share: 0.3,
      sword: {
        // namu：亂飛約 1s 換向、接觸 15%；鎖定突進可 1 次或連 3～4 次；末段插地 90%×5 本次不做
        contactRatio: 0.7,
        dashRatio: 0.8,
        wanderSec: 6,
        wanderSpeedPx: 630,
      ...
      // P2 小魔劍：同大劍邏輯，sprite＝Etc flyingSword2（lockon 借大劍）
      sword2: {
        assetKey: 'flyingSword2',
        lockAssetKey: 'flyingSword',
        contactRatio: 0.7,
        dashRatio: 0.8,
        wanderSec: 5,
        wanderSpeedPx: 700,
      ...
      crystal: {
        ...
        contactRatio: 1,
        contactCdSec: 1,
        // 正服：P2 起 1 顆；共血 ≤20% → 2；≤10% → 3（無圈內對王減傷）
        baseCount: 1,
        countAtHpRatio: [
          { hpRatio: 0.2, count: 2 },
          { hpRatio: 0.1, count: 3 },
      ...
      worldTree: {
        // HP≤hpRatio 觸發；skill8 引導 channelMs，期間累積破條 breakHpRatio
        // 成功→skill9→skillAfter9（期間玩家可打）；失敗→attack7（第 failDamageFrame 幀出傷）＋failRatio
        hpRatio: 0.2,
        channelMs: 10000,
        breakHpRatio: 0.008,
        groggyMs: 4400,
      ...
      meteor: {
        ...
        perWave: 5,
        waveGapMs: 320,
        // 波數由本體 skill2／skill5 空中段長度 ÷ waveGapMs 決定（不再寫死 waves）
        // 先堆在王身上再扇形射出
        stackHoldMs: 320,
        stackSpreadPx: 22,
        bodyYOffset: 60,
        ...
        hitRadiusPx: 56,
        hitRatio: 0.9,
        // skill5 自帶瞬移：0～9 原地；10 玩家頭上；100 離場；101 回原位
        appearFrame: 10,
        hideFrame: 100,
        returnFrame: 101,
        headYOffset: -140,
      ...
      // P2 attack3：本體龍捲期間持續發射（上下兩排×左右；波數＝動畫時長÷gap）
      tornadoBall: {
        topYOffset: -220,
        bottomYOffset: -36,
        speedPx: 520,
      ...
      // attack1：場上 5 個同高、不重疊 areaWarning；第 30 幀出傷一次
      multiAreaWarn: {
        count: 5,
        minDistPx: 150,
        awDamageFrame: 30,
      },
      // attack3／P2 attack4：同高多點預警；areaWarning 第 65 幀出傷＋暫停玩家 2s
      bindZones: {
        count: 5,
        minDistPx: 160,
        awDamageFrame: 65,
      ...
      phaseKits: {
        '8880100': {
          excludeActions: [
            'directionAct1', 'skillAfter1', 'skillAfter3', 'skillAfter4',
            'attack2', 'attack4', 'attack5', 'attack6',
          ],
          skillChain: {
            skill1: { afterKey: 'skillAfter1', damageFrame: 0, dmgRatio: 0 },
            skill3: { afterKey: 'skillAfter3', castDamageFrame: 34, dmgRatio: 1 },
            skill4: { afterKey: 'skillAfter4', castDamageFrame: 30, dmgRatio: 1 },
          },
          damienCast: {
            attack1: 'multiAreaWarn',
            skill2: 'meteor',
            attack3: 'bind',
          },
          attackHpRatio: {
        ...
        '8880101': {
          excludeActions: [
            'skillAfter1', 'skillAfter2', 'skillAfter3', 'skillAfter4', 'skillAfter6', 'skillAfter9',
            'attack2', 'attack5', 'attack6', 'attack7',
            'skill4', 'skill6', 'skill7',
          ...
          damienCast: {
            attack1: 'rushReturn',
            skill2: 'displaceAfterReturn',
            skill3: 'diveAfterOnPlayer',
            skill5: 'meteor',
            attack3: 'tornadoBall',
            attack4: 'bind',
          },
    ...
    difficulties: [
      {
        id: 'normal',
        hpMult: 1,
        // 各階實際可打血量（血條顯示固定 70／30，與此無關）
        formHpMult: {
          '8880100': 3000000000000,
          '8880101': 7000000000000,
        },
        dmgMult: 40,
        // 招式／世界樹 CD＝基準秒 × patternCdMult
        patternCdMult: 0.75,
        reqLevel: 170,
        timeLimitSec: 1800,
        rewards: [
          { kind: 'equip', itemId: '01004422', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01004423', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01004424', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01004425', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01004426', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01102775', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01102794', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01102795', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01102796', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01102797', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01082636', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01082637', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01082638', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01082639', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01082640', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01073030', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01073032', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01073033', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01073034', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01073035', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01152174', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01152176', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01152177', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01152178', amount: 1, chance: 2 },
          { kind: 'equip', itemId: '01152179', amount: 1, chance: 2 },
          ...
          { kind: 'etc', itemId: '04310156', amount: 1 },
          { kind: 'etc', itemId: '04310156', amount: 1 , chance: 10},
          { kind: 'etc', itemId: '02630291', amount: 1, chance: 20 },
      ...
      },
      {
        ...
        timeLimitSec: 1800,
        rewards: [
          { kind: 'equip', itemId: '01004422', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01004423', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01004424', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01004425', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01004426', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01102775', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01102794', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01102795', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01102796', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01102797', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01082636', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01082637', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01082638', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01082639', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01082640', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01073030', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01073032', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01073033', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01073034', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01073035', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01152174', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01152176', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01152177', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01152178', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01152179', amount: 1, chance: 5 },
          { kind: 'equip', itemId: '01372222', amount: 1, chance: 3 },
          { kind: 'equip', itemId: '01402251', amount: 1, chance: 3 },
          { kind: 'equip', itemId: '01522138', amount: 1, chance: 3 },
          { kind: 'equip', itemId: '01472261', amount: 1, chance: 3 },
          { kind: 'equip', itemId: '01222109', amount: 1, chance: 3 },
          { kind: 'equip', itemId: '01022278', amount: 1, chance: 0.1 },
          { kind: 'consume', consumeType: 'starforce_scroll', scrollId: 'scroll_set20', amount: 1, chance: 4 },
          { kind: 'consume', consumeType: 'starforce_scroll', scrollId: 'scroll_under23_30', amount: 1, chance: 2 },
          { kind: 'etc', itemId: '04310156', amount: 1 },
          { kind: 'etc', itemId: '04310156', amount: 1 , chance: 10},
          { kind: 'etc', itemId: '04310156', amount: 1 , chance: 30},
          { kind: 'etc', itemId: '02630291', amount: 1, chance: 30 },
      ...
      },
      {
        ...
        hpMult: 1,
        formHpMult: {
          '8880100': 500000000000000,
          '8880101': 1500000000000000,
        },
        dmgMult: 200,
        patternCdMult: 0.4,
        reqLevel: 250,
