...
const IDLE_ETC_DATABASE = [
  ...
  { id: 'maple_heart_warrior', name: '勇氣之心', icon: 'images/ETCicon/04001226.png', desc: '楓葉之心(劍士用)進階材料，可通過材料副本獲取。' },
  { id: 'maple_heart_magician', name: '智慧之心', icon: 'images/ETCicon/04001227.png', desc: '楓葉之心(法師用)進階材料，可通過材料副本獲取。' },
  { id: 'green_pendant', name: '綠色吊墜', icon: 'images/ETCicon/04000657.png', desc: '影武者蒙面進階材料，可通過材料副本獲取。' },
  { id: 'blue_pendant', name: '藍色吊墜', icon: 'images/ETCicon/04000656.png', desc: '影武者蒙面進階材料，可通過材料副本獲取。' },
  { id: 'red_pendant', name: '紅色吊墜', icon: 'images/ETCicon/04000655.png', desc: '影武者蒙面進階材料，可通過材料副本獲取。' },
  { id: 'yellow_pendant', name: '黃色吊墜', icon: 'images/ETCicon/04000658.png', desc: '影武者蒙面進階材料，可通過材料副本獲取。' },
  { id: 'purple_pendant', name: '紫色吊墜', icon: 'images/ETCicon/04000654.png', desc: '影武者蒙面進階材料，可通過材料副本獲取。' },
