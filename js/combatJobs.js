...
const CombatJobs = (() => {
  const jobOptions = [
    ...
    { name: '大魔導士（冰、雷）', category: 'normal', jobId: 222, skillBook: 222, skillLine: 'wizard', skillRank: '100' },
    { name: '巫師（火、毒）', category: 'normal', jobId: 210, skillBook: 210, skillLine: 'wizard', skillRank: '30' },
    { name: '魔導士（火、毒）', category: 'normal', jobId: 211, skillBook: 211, skillLine: 'wizard', skillRank: '60' },
    { name: '大魔導士（火、毒）', category: 'normal', jobId: 212, skillBook: 212, skillLine: 'wizard', skillRank: '100' },
    ...
    { name: '精靈遊俠', category: 'normal', aliases: ['精靈射手'], jobId: 2312, skillBook: 2312, skillLine: 'archer', skillRank: '100' },
  ...
  const jobStatDisplayGroups = [
    ...
    {
      names: ['法師', '巫師（冰、雷）', '魔導士（冰、雷）', '大魔導士（冰、雷）', '巫師（火、毒）', '魔導士（火、毒）', '大魔導士（火、毒）', '主教', '烈焰巫師', '龍魔導士', '夜光', '煉獄巫師', '伊利恩', '菈菈', '凱內西斯', '陰陽師', '琳恩'],
      main: 'INT', sub: 'LUK',
    },
    {
