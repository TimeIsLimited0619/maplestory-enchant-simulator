...
const SkillOverrides = (() => {
  ...
  const PATCHES = {
    ...
    '2200011': {
      h: '攻擊凍結狀態的敵人時，每層凍結使爆擊傷害增加#x%\\n使用閃電屬性攻擊時，每層凍結使最終傷害額外增加#y%，並減少1層凍結\\n（怪物身上顯示結冰特效）',
    ...
    // 獨角獸射擊：原所受傷害↑；平衡追加敵人攻擊力減少 10%
    '23111002': {
      h: '消耗#mpCon MP，對最多#mobCount名敵人造成#damage%傷害#attackCount次，有#prop%機率對目標套用減益效果，使其#time秒內遭受#x%傷害的追加傷害，敵人攻擊力減少#w%\\n冷卻時間：#cooltime秒。\\n使用連接技能時，冷卻時間減少1秒',
      desc: '召喚神聖的獨角獸攻擊前方敵人並弱化目標：追加所受傷害，並減少敵人攻擊力。',
      common: {
        w: '10',
      },
    },
